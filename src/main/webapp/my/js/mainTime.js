function timeLine(){
	...
	function setDatePosition(timelineComponents, min) {
		for (i = 0; i < timelineComponents['timelineDates'].length; i++) { 
		    ...
		    timelineComponents['timelineEvents'].eq(i).css('left', distanceNorm*min+10+'px');
		}
	}
	...
	*/
	...
	// 时间轴鼠标左右滑动特效
	var timeLineW = $("#timeLineBox").width();
	var drag=function(obj){  
	    ...
	    function move(event){ 
	    	if(event.clientX-gapX > 100){
	    		obj.css({  
	                "left":0+"px"
	                // "top":(event.clientY-gapY)+"px"  
	            	});  
	    	}else if(event.clientX-gapX < (0-timelineTotWidth+timeLineW)){
	    		obj.css({  
	                "left":(0-timelineTotWidth+timeLineW)+"px"
	                // "top":(event.clientY-gapY)+"px"  
	            	});
	    	}else{
	    		obj.css({  
	                "left":(event.clientX-gapX) - 300+"px"
	                // "top":(event.clientY-gapY)+"px"  
	            });
	    	}
