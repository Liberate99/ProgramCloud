    ...
    btable.set({
        ...
        columns: [{ //配置数据列
            ...
            format: function (val,obj) {
                var html = '<input type="button" value="编辑" data-action="edit" data-id="' + val + '" class="layui-btn layui-btn-xs" /> ' +
                    '<input type="button" value="删除" data-action="del" data-id="' + val + '" class="layui-btn layui-btn-xs layui-btn-danger" />';
                return html;
            }
        }],
        even: true,//隔行变色
