                    ...
                    s = o(
                        [
                            ...
                            function () {
                                ...
                                var eleStr = i.check && i.check == "checkbox" ? '<input type="checkbox" lay-skin="primary" lay-ignore="" name="' + i.checkboxName + '" ' + ((n.checked && n.checked == true) ? 'checked="checked"' : "") + (n.checkboxValue ? ('value="' + n.checkboxValue + '"') : "") + 'data-parent-id="' + n.pid + '"' + 'id="' + n.id + '"' + (i.checkboxStyle ? (' style="' + i.checkboxStyle + '"') : "") : '';
                                if (eleStr.length > 0) {
                                    //给元素添加data-xxx属性
                                    if (n.data && Object.prototype.toString.call(n.data) == "[object Object]") {
